...
{ 
  ...
  if (dxl_comm_result != COMM_SUCCESS || dxl_error != 0) {
    ROS_ERROR("Failed to set Profile Vel for Dynamixel ID %d: %s / %s",DXL1_ID);
    return -1;
  }
  ...
  if (dxl_comm_result != COMM_SUCCESS || dxl_error != 0) {
    ROS_ERROR("Failed to set P GAIN for Dynamixel ID %d: %s / %s",DXL1_ID);
    return -1;
  }
  ...
  if (dxl_comm_result != COMM_SUCCESS || dxl_error != 0) {
    ROS_ERROR("Failed to set D GAIN for Dynamixel ID %d: %s / %s",DXL1_ID);
    return -1;
  }
  ...
  if (dxl_comm_result != COMM_SUCCESS || dxl_error != 0) {
    ROS_ERROR("Failed to set Profile Vel for Dynamixel ID %d: %s / %s",DXL2_ID);
    return -1;
  }
  ...
  if (dxl_comm_result != COMM_SUCCESS || dxl_error != 0) {
    ROS_ERROR("Failed to set P GAIN for Dynamixel ID %d: %s / %s",DXL2_ID);
    return -1;
  }
  ...
  if (dxl_comm_result != COMM_SUCCESS || dxl_error != 0) {
    ROS_ERROR("Failed to set D GAIN for Dynamixel ID %d: %s / %s",DXL2_ID);
    return -1;
  }
  ...
  if (dxl_comm_result != COMM_SUCCESS || dxl_error != 0) {
    ROS_ERROR("Failed to set Profile Vel for Dynamixel ID %d: %s / %s",DXL3_ID);
    return -1;
  }
  ...
  if (dxl_comm_result != COMM_SUCCESS || dxl_error != 0) {
    ROS_ERROR("Failed to set D GAIN for Dynamixel ID %d: %s / %s",DXL3_ID);
    return -1;
  }
  ...
  if (dxl_comm_result != COMM_SUCCESS || dxl_error != 0) {
    ROS_ERROR("Failed to set Profile Vel for Dynamixel ID %d: %s / %s",DXL4_ID);
    return -1;
  }
  ...
  if (dxl_comm_result != COMM_SUCCESS || dxl_error != 0) {
    ROS_ERROR("Failed to set P GAIN for Dynamixel ID %d: %s / %s",DXL4_ID);
    return -1;
  }
  ...
  if (dxl_comm_result != COMM_SUCCESS || dxl_error != 0) {
    ROS_ERROR("Failed to set D GAIN for Dynamixel ID %d: %s / %s",DXL4_ID);
    return -1;
  }
  // dxl_comm_result = packetHandler->write1ByteTxRx(
